...
export class AuthService {
  ...
  async createUserVerification(dto: UserVerificationDto) {
    const { username, mobileNumber } = dto;
    return await this.usersService.createUserVerification(username, mobileNumber);
  }
